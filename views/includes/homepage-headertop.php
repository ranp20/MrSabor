...
?>
<div class="homepage">
	<div class="homepage__infotop infotop-background">
		<div class="box">
			<div class="homepage__infotop__header">
				...
				<div class="homepage__infotop__header--contmenucart">
					<div class="homepage__infotop__header--contmenucart__cont">
						<input type="hidden" value="<?= $_SESSION['client'][0]['id']; ?>" id="validCliSession">
						<div class="homepage__infotop__header--contmenucart__cont--cTitle">
							<h2>Lista en tus pedidos</h2>
						</div>
						<ul class="homepage__infotop__header--contmenucart__cont--menu" id="listProds_ByClienteAdd"></ul>
					</div>
				</div>
			</div>	
		</div>
